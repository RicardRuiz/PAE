...
void main(void)
{
	...
	//      que el compilador me a�ade automaticamente.
    ...
    while(1){
    	...
    	{  // Si el estado ha cambiado, respondemos a los cambios de estado, y escribimos info en LCD.
    		sprintf(cadena,"Estado: %02d",estado); //Nota: la funcion sprintf a�adira el caracter oculto de terminacion de cadena
